...
var BitArray = class {
	...
	*/
	constructor(buffer, bitSize, bitOffset) {
		...
		this.bitSize = bitSize !== null && bitSize !== void 0 ? bitSize : buffer.length * 8;
		this.byteSize = Math.trunc((this.bitSize + 7) / 8);
		this.bitOffset = bitOffset !== null && bitOffset !== void 0 ? bitOffset : 0;
...
function bitArrayByteAt(buffer, bitOffset, index) {
	if (bitOffset === 0) {
		var _buffer$index;
		return (_buffer$index = buffer[index]) !== null && _buffer$index !== void 0 ? _buffer$index : 0;
...
function pop_grapheme(string) {
	...
	const iterator = graphemes_iterator(string);
	if (iterator) {
		var _iterator$next$value;
		first = (_iterator$next$value = iterator.next().value) === null || _iterator$next$value === void 0 ? void 0 : _iterator$next$value.segment;
	} else {
		var _string$match;
		first = (_string$match = string.match(/./su)) === null || _string$match === void 0 ? void 0 : _string$match[0];
	}
